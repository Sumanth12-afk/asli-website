...
export const loadImagesByPrefix = (prefix) => {
  ...
  const imageDatabase = {
    ...
    food: [
      ...
      { filename: 'food04.jpg', title: 'Shahi Shadoot Tukda and Gulkand Aut Chocolate', description: 'Royal bread pudding with rich cream and rose-chocolate fusion dessert', category: 'Dessert', ingredients: 'Bread, Milk, Sugar, Gulkand, Chocolate, Nuts' },
